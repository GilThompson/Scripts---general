...
###Toma de tiempo de procesado
old <- Sys.time()
print(old)

#### Get functions and libraries
#source("F:\\Dropbox\\Software\\Scripts\\r\\extract\\functions_extract.R") #Check that this file location
source("C:/Users/ITHOMPSON/Documents/GitHub/Scripts---general/r/extract/functions_extract_C.R") #Check that this file location
#require(raster)
...
outFolder <- ("C:\\Users\\ITHOMPSON\\Desktop\\output")
#summarize using the selected function
func <- NULL #"mean" #mean #min #max
...
###Toma de tiempo de procesado
new <- Sys.time() # calculate difference
time <- new - old 

print(time ) # print in nice format